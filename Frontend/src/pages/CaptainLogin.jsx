...
const captainLogin = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            // Optionally, display user-friendly error feedback here.
        }
  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
        ...
        <form onSubmit={(e) => {
            ...
            <p className='text-center'>Wanna Join Fleet?<Link to='/captain-signup' className='text-[#f73e44]'> Register as a captain</Link></p>
        </div>
        <div>
            <Link to='/login' className='bg-[#f73e44] flex items-center justify-center text-white font-semibold mb-5 rounded px-4 py-2 w-full text-lg placeholder:text-base'>Sign in as User</Link>
        </div>
    </div>
  )
}
